  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0f1115] font-sans selection:bg-emerald-500/30 text-white overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left space-y-8 order-2 lg:order-1">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                ZapPRO: Plataforma técnica estilo Zap <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-200 to-emerald-400 animate-gradient-x">para o refrigerista brasileiro</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">Tudo o que faltava na rotina: conversa rápida, passo-a-passo das soluções, macetes, diagnósticos e dicas mastigadas no formato que é fácil pegar e aplicar. Não é mais grupo, nem robô perdido – é SaaS pensado pra obra, direto no chat, feito por quem é do campo.</p>
              ...
              <div className="pt-8 flex items-center justify-center lg:justify-start gap-4 text-xs font-mono text-gray-400 uppercase tracking-widest">Entra, manda dúvida, vê como é diferente. Nem grupo de zap nem IA genérica.</div>
            </div>
            <div className="relative mx-auto order-1 lg:order-2 perspective-1000">
              ...
              <div className="relative w-[320px] h-[680px] bg-slate-900 rounded-[55px] border-[6px] border-[#3f3f46] shadow-[0_0_0_2px_#52525b,0_20px_50px_-10px_rgba(0,0,0,0.5)] mx-auto overflow-hidden animate-float gpu-transform">
                ...
                <div className="w-full h-full bg-[#E5DDD5] rounded-[48px] overflow-hidden flex flex-col relative">
                  ...
                  <div className="flex-1 p-3 space-y-3 overflow-hidden flex flex-col justify-end pb-4"><div className="flex justify-center mb-2"><span className="bg-[#e2e8f0] text-slate-500 text-[10px] font-bold px-2 py-1 rounded shadow-sm">Hoje</span></div><div className="flex justify-end"><div className="bg-[#DCF8C5] p-3 rounded-2xl rounded-tr-sm shadow-sm max-w-[85%] relative"><p className="text-xs text-black leading-relaxed">Meu inverter não liga, tá piscando três vezes.</p><div className="text-[9px] text-slate-500 text-right mt-1 flex justify-end gap-1">10:42 <span className="text-[#34B7F1]">✓✓</span></div></div></div><div className="flex justify-start"><div className="bg-white p-3 rounded-2xl rounded-tl-sm shadow-sm max-w-[90%] relative"><p className="text-[10px] font-bold text-emerald-600 mb-1">ZapPRO IA</p><p className="text-xs text-black leading-relaxed">Checa tensão, relê, fluxo de ar... já te mando o teste certo!</p><div className="mt-2 bg-slate-50 p-2 rounded border border-slate-100"><div className="flex items-center gap-2 mb-1"><span className="w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center text-[10px]">▶</span><div className="h-1 bg-slate-200 rounded-full flex-1"></div></div><p className="text-[9px] text-slate-500">Áudio explicativo (0:45)</p></div><div className="flex gap-2 mt-2"><span className="bg-slate-100 text-slate-600 border border-slate-200 px-2 py-1 rounded-full text-[9px]">⚡ Teste IPM</span><span className="bg-slate-100 text-slate-600 border border-slate-200 px-2 py-1 rounded-full text-[9px]">📘 Manual</span></div><div className="text-[9px] text-slate-500 text-right mt-1">10:42</div></div></div></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
              <div className="md:col-span-2 md:row-span-2 bg-[#18181b] rounded-3xl p-8 border border-white/5 relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Do campo pra tela</h3>
                  <p className="text-gray-300 mb-8 leading-relaxed">Feito pra quem conhece a correria da manutenção. Chega de gambiarra: receba roteiro de teste, ajuste, diagnóstico e dica quente, sem enrolação ― como técnico fala pra técnico.</p>
              ...
              <div className="md:col-span-1 md:row-span-1 bg-[#18181b] rounded-3xl p-6 border border-white/5 relative overflow-hidden group hover:border-blue-500/30 transition-colors">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Chat like Zap, mas profissional</h3>
                <p className="text-xs text-gray-300">Visual de WhatsApp, mas é SaaS de verdade. Não precisa baixar app, não depende do Whats, roda direto no navegador, entra e já vê resposta, passo-a-passo e troca ideia na mesma tela.</p>
              </div>
              <div className="md:col-span-1 md:row-span-1 bg-[#18181b] rounded-3xl p-6 border border-white/5 relative overflow-hidden group hover:border-purple-500/30 transition-colors">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Do Split Inverter ao VRF</h3>
                <p className="text-xs text-gray-300">Serve desde o básico até os sistemas avançados ― Split comum, janela, inverter, multi, central, VRF, tudo que cai na mão do técnico. Foco é resolver sem perder tempo com manual difícil nem depender de fabricante.</p>
              </div>
              <div className="md:col-span-2 md:row-span-1 bg-gradient-to-r from-emerald-900/40 to-[#18181b] rounded-3xl p-6 border border-white/5 flex items-center justify-between relative overflow-hidden"><div className="relative z-10"><h3 className="text-xl font-bold text-white mb-2">Manuais e macetes mastigados</h3><p className="text-sm text-gray-300 max-w-xs">Manual técnico atualizado, dica de campo, tabela de erro, procedimento de teste, tudo explicado fácil e pronto pra aplicar. Está sempre à mão no chat, no formato que o técnico entende na hora.</p></div><div className="text-6xl opacity-20 grayscale saturate-0 animate-pulse">📚</div></div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10">
            <div className="bg-gradient-to-b from-[#1c1c21] to-[#131316] rounded-[40px] p-1 border border-white/10 shadow-2xl">
              <div className="bg-[#18181b] rounded-[36px] p-8 md:p-16 text-center relative overflow-hidden">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Testar grátis</h2>
                <p className="text-gray-300 mb-10">Entra, manda dúvida, vê como é diferente. Nem grupo de zap nem IA genérica. É solução pensada – clica, testa e sente a diferença na rotina.</p>
        ...
        <footer className="py-12 border-t border-white/5 bg-[#0a0a0c] text-center text-gray-400 text-sm"><p className="mb-2">Feito por quem vive obra. Plataforma independente, sem rabo preso com marca.</p><p>&copy; {new Date().getFullYear()} ZapPRO - Soluções para Ar-condicionado</p></footer>
      </div>
    </>
  )
}
